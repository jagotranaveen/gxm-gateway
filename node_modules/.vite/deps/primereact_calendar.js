...
var Calendar = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var isTypingRef = React3.useRef(false);
  var metaData = {
    props,
    state: {
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React3.createElement("div", containerProps, React3.createElement("table", tableProps, React3.createElement("thead", tableHeaderProps, React3.createElement("tr", tableHeaderRowProps, dayNames)), React3.createElement("tbody", tableBodyProps, dates)));
  };
  var createMonth = function createMonth2(monthMetaData, index) {
    ...
    return React3.createElement("div", _extends3({}, groupProps, {
      key: monthKey
    }), React3.createElement("div", headerProps, header, backwardNavigator, title, forwardNavigator), dateViewGrid);
  };
